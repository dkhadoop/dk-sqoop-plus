...
public class ExportTool extends com.cloudera.sqoop.tool.BaseSqoopTool {
  ...
  private void exportTableToEs(SqoopOptions options, String tableName)
          throws ExportException, IOException {
    String jarFile = null;
  ...
  protected void validateExportOptions(SqoopOptions options)
      throws InvalidOptionsException {
    if ((!options.getConnectString().contains("es@")) && options.getTableName() == null && options.getCall() == null) {
