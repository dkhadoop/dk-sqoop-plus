...
public abstract class BaseSqoopTool extends com.cloudera.sqoop.tool.SqoopTool {
  ...
  // string.
  public static final String CONNECT_ES_ARG = "es";
  ...
  protected boolean init(SqoopOptions sqoopOpts) {
    ...
    try {
      ...
      if(sqoopOpts.getConnectString().contains("es@")){
  ...
  protected RelatedOptions getESOptions() {
    RelatedOptions esOpts =
            new RelatedOptions("ES arguments");
    esOpts.addOption(OptionBuilder.withArgName("table")
            .hasArg()
            .withDescription("Import to <table> in ES")
            .withLongOpt(CONNECT_ES_ARG)
            .create());
