...
//    Path outputPath = new Path(context.getTableName());
  ...
  public void runImport(String tableName, String ormJarFile, String splitByCol,
    ...
    if(options.getTargetDir() != null && options.getTargetDir().contains("@")){
      ...
      String esips = split[0];
      String esclustername = split[1];
      String indexAndTypeName = split[2];
      ...
      conf.set("es.resource", indexAndTypeName);
